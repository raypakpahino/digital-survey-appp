...
// Helper to sanitize incoming survey question fields without losing images or toggles
const sanitizeQuestions = (questions) => {
  return (questions || []).map((q) => ({
    _id: q._id,
    type: String(q.type || 'smiley'),
    questionText: String(q.questionText || ''),
    questionImage: String(q.questionImage || ''), // Universal Question Header Image
